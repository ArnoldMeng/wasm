...
//  lenet
//
//  Created by 孟亚文 on 2019/6/14.
//  Copyright © 2019 孟亚文. All rights reserved.
//
...
void train(Sample *train_sample, double learning_rate) {
    ...
    for (i = 0; i < batch_count; i++) {
        ...
        for (j = 0; j < batch_size; j++) {
            ...
            timer3 = clock();
            time1 += (double)(timer2 - timer1) / CLOCKS_PER_SEC;
            time2 += (double)(timer3 - timer2) / CLOCKS_PER_SEC;
        }
        
        // 更新权值
        timer3 = clock();
        update_weights(learning_rate);
        double time3 = (double)(clock() - timer3) / CLOCKS_PER_SEC;
...
int main1() {
    ...
    FILE *fp = NULL;
    fp = fopen("/static/hello.c", "rb");
    if(fp == NULL) {
        cout << "load hello.c failed." << endl;
    } else {
        cout << "load hello.c succeeded." << endl;
    }
    return 0;
}
...
int main2() {
    ...
    const char* train_sample_path = "/Users/mengyawen/Dreamer/wasm/static/mnist/train-images-idx3-ubyte";
    const char* train_label_path = "/Users/mengyawen/Dreamer/wasm/static/mnist/train-labels-idx1-ubyte";
    ...
    const char* test_sample_path = "/Users/mengyawen/Dreamer/wasm/static/mnist/t10k-images-idx3-ubyte";
    const char* test_label_path = "/Users/mengyawen/Dreamer/wasm/static/mnist/t10k-labels-idx1-ubyte";
